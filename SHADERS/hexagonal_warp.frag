...
void main() {
    ...
    float sn1 = snoise(cell_id * 0.7 + t * 0.25) * 0.5 + 0.5;
    float sn2 = snoise(cell_id * 0.7 + t * 0.3 + 30.0) * 0.5 + 0.5;
    vec2 warp = vec2(
        sin(t * cell_speed + cell_phase) * sn1,
        cos(t * cell_speed * 0.9 + cell_phase) * sn2
